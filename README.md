...
---
## 📖 Документация API
В проекте используется [спецификация OpenAPI](./eventify-backend/openapi.yaml) 
...
- [Инструкции по Бэкенду](./eventify-backend/README.md)
- [Инструкции по Фронтенду](./eventify-frontend/README.md)
